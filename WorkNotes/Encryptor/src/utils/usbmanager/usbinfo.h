...
void resolveUsbInfo(UsbDevice* usbDevice, uint16_t & pid, uint16_t& vid, uint16_t &cid, bool resolveAll = true);

QPair<uint16_t, uint16_t> getDevPidVid(libusb_device *device);
}
}
