...
ScpSession::ScpSession(const std::string &user, const std::string &passwd, const std::string &ip, unsigned short sshPort, const std::string &id)
    : Session(SessionType::SCP, user, passwd, ip, sshPort, id)
{
